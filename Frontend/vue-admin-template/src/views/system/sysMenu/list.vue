<template>
    ...
    <el-table-column label="操作" width="180" align="center" fixed="right">
        ...
        <el-button type="danger" icon="el-icon-delete" size="mini" @click="removeDataById(scope.row.id)" title="删除"  :disabled="scope.row.children.length > 0 || $hasBP('bnt.sysMenu.update')  === false"/>
        </template>
    </el-table-column>
    </el-table>
